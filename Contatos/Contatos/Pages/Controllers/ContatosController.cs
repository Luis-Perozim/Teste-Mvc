    ...
    public class ContatosController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Contatos != null ? 
                          ...
                          Problem("Entity set 'ContatoContexto.Contatos'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Endereco,Cidade,Estado,Cep,Fone,Email")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Endereco,Cidade,Estado,Cep,Fone,Email")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ContatoContexto.Contatos'  is null.");
            }
            var contato = await _context.Contatos.FindAsync(id);
            if (contato != null)
            {
